...
//const url = 'https://kubernetes.io/docs/setup/production-environment/tools/_print/';
//const pdf = 'k8s-spray.pdf'
const url = 'https://kubernetes.io/docs/tasks/run-application/_print/';
const pdf = 'k8s-run-app.pdf'
