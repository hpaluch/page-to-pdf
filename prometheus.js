...
const startUrl = 'https://prometheus.io/docs/introduction/overview/';
const prefixUrl = 'https://prometheus.io/docs/';
const pdf = 'prometheus-docs.pdf';
...
(async () => {
  ...
  let links  = await page.$$eval('div.side-nav-col > ul.nav li > a',
  ...
  for (var i=0; i<links.length;i++) {
    ...
    let html = await page.$eval('div.doc-content', (element) => {
