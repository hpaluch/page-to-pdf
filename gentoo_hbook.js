// export Prometheus docs to PDf pages
//
// based on: https://github.com/facebook/docusaurus/issues/969#issuecomment-595012118

const startUrl = 'https://wiki.gentoo.org/wiki/Handbook:AMD64';
const prefixUrl = 'https://wiki.gentoo.org/wiki/Handbook:AMD64/';
const pdf = 'gentoo-handbook.pdf';
...
(async () => {
  ...
  let links  = await page.$$eval('div.mw-parser-output > dl > dt > a',
  ...
  for (var i=0; i<links.length;i++) {
    ...
    let html = await page.$eval('div.mw-parser-output', (element) => {
