...
const startUrl = 'https://rancher.com/docs/rancher/v2.6/en/overview/';
const prefixUrl = 'https://rancher.com/docs/rancher/v2.6/en/';
const pdf = 'rancher-docs.pdf';
...
(async () => {
  ...
  let links  = await page.$$eval('div.guide-menus a',
...
//  process.exit(123);
  ...
  for (var i=0; i<links2.length;i++) {
    ...
    let html = await page.$eval('body div.docs-wrap', (element) => {
