...
const startUrl = 'https://snapcraft.io/docs';
const prefixUrl = startUrl;
const pdf = 'snap-docs.pdf';
...
(async () => {
  ...
  let links  = await page.$$eval('nav#default ul li > a',
  ...
  for (var i=0; i<links.length;i++) {
    ...
    await page.addStyleTag({url: 'https://snapcraft.io/static/css/styles.css?v=8f984aa'});
