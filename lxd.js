...
const startUrl = 'https://linuxcontainers.org/lxd/docs/master/index';
const prefixUrl = 'https://linuxcontainers.org/lxd/docs/master/';
const pdf = 'lxd-docs.pdf';
...
(async () => {
  ...
  let links  = await page.$$eval('aside#navigation nav ul li.p-sidebar-nav__item > a',
  ...
  for (var i=0; i<links.length;i++) {
    ...
    // LXD website uses only embedded <style/> with
    // one "normalized" looooong line - thus ignoring all styles...
